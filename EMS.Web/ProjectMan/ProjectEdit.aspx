<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectEdit.aspx.cs" Inherits="EMS.Web.ProjectMan.ProjectEdit" %>
...
<body>
    <form id="formEdit" name="formEdit" runat="server" class="demoform">
        <div class="Teaching_plan_management">
            ...
            <h1 class="Page_name">项目：<span id="PlanName"></span>-->项目修改</h1>
            <table class="InfoTable">
                 <tbody>
                <tr>
                    <td><span>项目编号：</span></td>
                    <td><span>
                        <input id="txt_Number" type="text" class="hu" placeholder="请输入项目编号" datatype="*" errormsg="不能为空" /></span></td>
                    <td><span>项目名称：</span></td>
                    <td><span>
                        <input id="txt_Name" type="text" class="hu"  placeholder="请输入项目名称" datatype="*" errormsg="不能为空"  /></span></td>
