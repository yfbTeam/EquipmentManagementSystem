<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContractList.aspx.cs" Inherits="EMS.Web.Contract.ContractList" %>
...
<body>
    <form id="form1" runat="server">
        <div class="Teaching_plan_management">
            <h1 class="Page_name">合同管理</h1>
            <div class="Operation_area clearfix">
                <div class="left_choice fl">
                    <ul class="clearfix">
                        <li class="Sear">
                            <input type="text" name="search_w" class="search_w" id="ContractName" placeholder="请输入合同名称" value="" />
                        </li>
                        <li class="Sear">
                ...
                <div class="fr">
                     <a  class="btn1" href="ContractEdit.aspx?p=add">添加</a>
                </div>
            </div>
    ...
    <script type="text/javascript">
        ...
        function UpdateContract(obj, Id) {
            window.location = 'ContractEdit.aspx?Id=' + Id+"&p=edit";
        ...
        function ContractDetails(obj,Id) {
            ...
            OpenIFrameWindow('合同详细：' + CName, 'ContractDetails.aspx?Id=' + Id, '700px', '600px');
            return false;
        }
