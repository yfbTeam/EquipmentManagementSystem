<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelectionEquip.aspx.cs" Inherits="EMS.Web.OfficeFurniture.SelectionEquip" %>
...
<head runat="server">
    ...
    <script id="trTemp" type="text/x-jquery-tmpl">
        <tr>
            ...
            <td>
                <input class="Topic_btn" type="button" value="添加" onclick="AddEquip(this, '${Id}', '${AssetName}', '${AssetNumber}', '${Type}', '${EquipStatusChange(EquipStatus)}', '${Unit}', '{EquipDatailID}')" /></td>
            {{else}}
            {{if isloadDataItem(Id)==false }}
            <td>
                <input class="Topic_btn" type="button" value="取消" onclick="CancelEquip(this, '${Id}', '${AssetName}')" /></td>
            {{/if}}
             {{/if}}
        </tr>
...
<body>
            ...
            <div class="thetrth">
                <ul>
                    ...
                    <li class="Select clearfix"">
                        ...
                        <input id="EquipName" type="text" name="search_w" class="search_w" placeholder="请输入设备名称" value="" style="height:30px; float: left; margin-left: 10px;" />
                        <a class="btn1" href="#" onclick="javascript:SearchData();" style="margin-left: 10px; padding: 0px 8px; width: 60px; text-align: center;">搜索</a>
                        <a class="btn1" href="#" onclick="javascript:AddAll();" style="margin-left: 10px; padding: 0px 8px; width: 60px; text-align: center;">批量添加</a>
                    </li>
    ...
    <script type="text/javascript">
        ...
        var UserRoleID = $("#hid_UserIDCard").val();
        ...
        function GetList(PageIndex) {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    , "EquipSource": EquipSource, "BorrowYN": 1, "EquipStatus": 0, "action": "GetPageEquipDetail"
                },
        ...
        function AddEquip(obj, id, name, number, type, status, unit, EquipDatailID) {
            var save = new Object();
            save.id = id;
            save.EquipDatailID = id;
            save.name = name;
            save.number = number;
            save.type = type;
            save.status = status;
