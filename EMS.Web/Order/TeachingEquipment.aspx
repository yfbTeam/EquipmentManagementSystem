<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TeachingEquipment.aspx.cs" Inherits="EMS.Web.Order.TeachingEquipment" %>
    ...
    <script id="tr_User" type="text/x-jquery-tmpl">
        <tr>
            ...
            <td>
                ...
                <span class=" "><%--{if EquipStatus == 0}}
                    {{if IsConsume == 0}}
                <input type="button" class="Topic_btn" value="报修" onclick="OpenIFrameWindow('报修', 'RepairEdit.aspx?eqID=${Id}', '650px', '360px')" />
                    {{else}}
                {{if EquipStatus == 1 }}
                     {{if IsConsume == 0}}
                   <input type="button" class="Topic_btn" value="报修" onclick="OpenIFrameWindow('报修', 'RepairEdit.aspx?eqID=${Id}', '650px', '360px')" />
...
<body>
    ...
    <form id="form1" runat="server">
        <div class="Teaching_plan_management">
            <h1 class="Page_name">教学仪器管理</h1>
            <div class="Operation_area">
                <div class="left_choice fl">
                    <ul>
                        <li class="Sear">
                            <%--办公室：<select id="sel_Room" name="sel_Room" class="search_w">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        BindSerDropDownList("sel_Room", WebServiceUrl + "/SystemSettings/Building.ashx", { type: "2", "action": "GetRoomInfoByType" }, true);//根据类型绑定房间信息
