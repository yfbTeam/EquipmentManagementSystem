<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Escheat.aspx.cs" Inherits="EMS.Web.Order.Escheat" %>
...
<script id="trTemp" type="text/x-jquery-tmpl">
    ...
    <tr id="${Barcode}" >
        ...
        <th class="Project_name">${Barcode}</th>
            ...
            <div class="Teaching_plan_management">
                ...
                <div class="Operation_area">
                    ...
                    <div class="right_add fr">
                        ...
                        <input type="button" class="Topic_btn" onclick="javascript: toLend()" value="确认" />
                    </div>
                </div>
    ...
    <script>
        ...
        function getData(startIndex, orderNo, Type) {
            $.ajax({
                ...
                dataType: "jsonp",
                jsonp: "jsoncallback",
                data: { "orderID": orderNo, "action": "GetDateEscheat" },
                success: OnSuccess,
                error: OnError
            });
        ...
        function OnSuccess(json) {
            if (json.result == "no") {
                ...
                $("#tbList tbody").html('');
                $("#trTemp").tmpl(json.result).appendTo("#tbList");
                //隔行变色以及鼠标移动高亮
        ...
        function OnSuccessgetDataByBarcode(json) {
            ...
            if (json.result == null) {
                ...
                if (isok) {
                    ...
                    if ($("#" + json.result.Barcode).length > 0) {
                        $("#" + json.result.Barcode).css('background-color','#66ff66'); 
                        
                        if (strADD != "") {
                            strADD += ","
                        }
                        strADD +=  json.result.Id;
        ...
        function toLend() {
            ...
            $.ajax({
                ...
                dataType: "jsonp",
                jsonp: "jsoncallback",
                data: { "strData": strADD, "orderID": UrlDate.orderNo, "IDCard": UrlDate.IDCard, "stuCard": UrlDate.stuCard, "action": "ToEscheat" },
