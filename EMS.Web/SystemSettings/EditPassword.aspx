<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditPassword.aspx.cs" Inherits="EMS.Web.SystemSettings.EditPassword" %>
...
<script type="text/javascript">
    ...
    function SavePwd() {
        ...
        var useridcard = $("#<%=hid_UserIDCard.ClientID%>").val();
        ...
        $.ajax({
            ...
            dataType: "jsonp",
            jsonp: "jsoncallback",
            data: {oldpwd: oldpwd, useridcard: useridcard,pwd: pwd,action: "EditPassword"},
